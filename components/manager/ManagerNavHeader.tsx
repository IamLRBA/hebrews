...
const NAV_ITEMS = [
  { href: '/manager/dashboard', label: 'Dashboard', iconOutline: IconLayoutDashboard, iconFilled: IconLayoutDashboardFilled },
    ...
    <header className="pos-dashboard-header flex flex-col gap-4 mb-6 pos-dashboard-header-sticky">
      <div className="flex flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 ml-auto">
          <span className="text-sm text-neutral-500 dark:text-neutral-400 font-medium">Manager Panel</span>
          <SettingsDropdown />
        </div>
      </div>
