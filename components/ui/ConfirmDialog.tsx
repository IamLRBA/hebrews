...
export function ConfirmDialog({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 dark:bg-black/60">
      <div
        className="bg-white dark:bg-neutral-900 rounded-xl shadow-xl border border-neutral-200 dark:border-neutral-800 w-full max-w-sm overflow-hidden"
        role="dialog"
        aria-modal="true"
      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-neutral-200 dark:border-neutral-800">
          <h2 id="confirm-dialog-title" className="text-base font-semibold text-neutral-900 dark:text-neutral-100 text-center flex-1">
            {title}
          </h2>
          <button
            type="button"
        ...
        <p id="confirm-dialog-desc" className="p-4 text-sm text-neutral-600 dark:text-neutral-400 text-center">
          {message}
        </p>
        <div className="flex gap-3 p-4 border-t border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-800/50">
          ...
          <button
            type="button"
            onClick={onConfirm}
            className={danger ? 'btn btn-danger flex-1' : 'btn btn-primary flex-1'}
          >
            {confirmLabel}
          </button>
        </div>
