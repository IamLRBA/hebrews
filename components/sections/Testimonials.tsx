...
const defaultTestimonials: Testimonial[] = [
  { id: 1, text: "Cafe Hebrews offers an extraordinary culinary experience. The artisanal coffee and gourmet dishes are always perfectly prepared and their attention to detail is exceptional.", fullText: "Cafe Hebrews offers an extraordinary culinary experience. The artisanal coffee and gourmet dishes are always perfectly prepared and their attention to detail is exceptional. I've made this my regular dining destination, and every visit tells a story of luxury and sophistication. The quality and uniqueness of their menu is unmatched.", author: "Brian Najuna", company: "Culinary Enthusiast", image: "/assets/images/testimonials/brian-najuna.jpg", rating: 5 },
  ...
  { id: 3, text: "The blend of traditional and modern cuisine they offer is exactly what I was looking for. Their menu curation is impeccable.", fullText: "The blend of traditional and modern cuisine they offer is exactly what I was looking for. Their menu curation is impeccable. Cafe Hebrews has helped me discover flavors that are both timeless and contemporary. Their attention to detail and quality is evident in every dish they create.", author: "Irene Lekuru Gasper", company: "Food Blogger", image: "/assets/images/testimonials/irene-lekuru-gasper.jpg", rating: 5 },
  { id: 4, text: "Their personalized service has transformed my dining experience. I now feel truly valued as a guest every time I visit.", fullText: "Their personalized service has transformed my dining experience. I now feel truly valued as a guest every time I visit. The team at Cafe Hebrews doesn't just serve food - they craft unforgettable experiences. Their personalized approach makes all the difference.", author: "Sekina Paws", company: "Marketing Professional", image: "/assets/images/testimonials/sekina-paws.jpg", rating: 5 },
  { id: 5, text: "Their luxury ambiance is absolutely stunning. Every detail has been thoughtfully designed to create an atmosphere you just can't find anywhere else.", fullText: "Their luxury ambiance is absolutely stunning. Every detail has been thoughtfully designed to create an atmosphere you just can't find anywhere else. Cafe Hebrews has become my sanctuary for both business meetings and personal indulgence. Their attention to creating a perfect environment ensures every visit is special.", author: "Sizi", company: "Business Executive", image: "/assets/images/testimonials/sizi.jpg", rating: 5 },
  { id: 6, text: "The exclusive dining experience is worth every moment. They've completely transformed how I view luxury cafes.", fullText: "The exclusive dining experience is worth every moment. They've completely transformed how I view luxury cafes. The team at Cafe Hebrews understands that dining is about creating memories and elevating the ordinary. Their commitment to excellence has made all the difference in my dining experiences.", author: "Yusuf Wasswa", company: "Business Owner", image: "/assets/images/testimonials/yusuf-wasswa.jpg", rating: 5 },
]
