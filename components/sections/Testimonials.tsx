...
const defaultTestimonials: Testimonial[] = [
  ...
  { id: 6, text: "The personal styling service is worth every penny. They've completely transformed my confidence and style.", fullText: "The personal styling service is worth every penny. They've completely transformed my confidence and style. The team at MysticalPIECES understands that fashion is about self-expression and empowerment. Their personalized approach has made all the difference in my wardrobe.", author: "Amanda S.", company: "Business Owner", image: "/assets/images/testimonials/derrick-jnr.jpg", rating: 5 },
]
