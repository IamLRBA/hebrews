...
const defaultTestimonials: Testimonial[] = [
  ...
  { id: 3, text: "The blend of vintage and contemporary pieces they offer is exactly what I was looking for. Their curation is impeccable.", fullText: "The blend of vintage and contemporary pieces they offer is exactly what I was looking for. Their curation is impeccable. MysteryPieces has helped me create a wardrobe that's both timeless and trendy. Their attention to detail and quality is evident in every piece they select.", author: "Jessica L.", company: "Fashion Blogger", image: "/assets/images/testimonials/jessica-l.jpg", rating: 5 },
  { id: 4, text: "Their styling consultations have transformed how I approach fashion. I now feel confident in every outfit I wear.", fullText: "Their styling consultations have transformed how I approach fashion. I now feel confident in every outfit I wear. The team at MysteryPieces doesn't just sell clothes - they help you discover your authentic style. Their personalized approach makes all the difference.", author: "Maria R.", company: "Marketing Professional", image: "/assets/images/testimonials/brian-najuna.jpg", rating: 5 },
  { id: 5, text: "Their vintage collection is absolutely stunning. Every piece has character and quality that you just can't find in fast fashion.", fullText: "Their vintage collection is absolutely stunning. Every piece has character and quality that you just can't find in fast fashion. MysteryPieces has helped me build a wardrobe that's both unique and sustainable. Their curation process ensures every item is special.", author: "Lisa T.", company: "Vintage Collector", image: "/assets/images/testimonials/lisa-t.jpg", rating: 5 },
  { id: 6, text: "The personal styling service is worth every penny. They've completely transformed my confidence and style.", fullText: "The personal styling service is worth every penny. They've completely transformed my confidence and style. The team at MysteryPieces understands that fashion is about self-expression and empowerment. Their personalized approach has made all the difference in my wardrobe.", author: "Amanda S.", company: "Business Owner", image: "/assets/images/testimonials/derrick-jnr.jpg", rating: 5 },
]
