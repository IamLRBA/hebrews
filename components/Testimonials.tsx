...
const testimonialsData: Testimonial[] = [
  {
    id: 1,
    text: "FusionCRAFT STUDIOS has an incredible eye for unique fashion finds. Their thrifted pieces are always in perfect condition and their styling advice is spot-on.",
    fullText: "FusionCRAFT STUDIOS has an incredible eye for unique fashion finds. Their thrifted pieces are always in perfect condition and their styling advice is spot-on. I've built most of my wardrobe from their curated collection, and every piece tells a story. The quality and uniqueness of their items is unmatched.",
    author: "Sarah M.",
    company: "Fashion Enthusiast",
    image: "/assets/images/testimonials/sarah-m.jpg",
    rating: 5
  },
  {
    id: 2,
    text: "Their sustainable fashion approach is refreshing. They've helped me discover my personal style while being environmentally conscious.",
    fullText: "Their sustainable fashion approach is refreshing. They've helped me discover my personal style while being environmentally conscious. The team understands that fashion should be both beautiful and responsible. Every piece I've purchased has been a perfect fit for my lifestyle and values.",
    author: "Emma K.",
    company: "Style Consultant",
    image: "/assets/images/testimonials/emma-k.jpg",
    rating: 5
  },
  {
    id: 3,
    text: "The blend of vintage and contemporary pieces they offer is exactly what I was looking for. Their curation is impeccable.",
    fullText: "The blend of vintage and contemporary pieces they offer is exactly what I was looking for. Their curation is impeccable. FusionCRAFT STUDIOS has helped me create a wardrobe that's both timeless and trendy. Their attention to detail and quality is evident in every piece they select.",
    author: "Jessica L.",
    company: "Fashion Blogger",
    image: "/assets/images/testimonials/jessica-l.jpg",
    rating: 5
  },
  {
    id: 4,
    text: "Their styling consultations have transformed how I approach fashion. I now feel confident in every outfit I wear.",
    fullText: "Their styling consultations have transformed how I approach fashion. I now feel confident in every outfit I wear. The team at FusionCRAFT STUDIOS doesn't just sell clothes - they help you discover your authentic style. Their personalized approach makes all the difference.",
    author: "Maria R.",
  ...
  {
    id: 5,
    text: "Their vintage collection is absolutely stunning. Every piece has character and quality that you just can't find in fast fashion.",
    fullText: "Their vintage collection is absolutely stunning. Every piece has character and quality that you just can't find in fast fashion. FusionCRAFT STUDIOS has helped me build a wardrobe that's both unique and sustainable. Their curation process ensures every item is special.",
    author: "Lisa T.",
    company: "Vintage Collector",
    image: "/assets/images/testimonials/lisa-t.jpg",
    rating: 5
  },
  {
    id: 6,
    text: "The personal styling service is worth every penny. They've completely transformed my confidence and style.",
    fullText: "The personal styling service is worth every penny. They've completely transformed my confidence and style. The team at FusionCRAFT STUDIOS understands that fashion is about self-expression and empowerment. Their personalized approach has made all the difference in my wardrobe.",
    author: "Amanda S.",
