    ...
    <main className="pos-page min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center p-6 overflow-auto">
        <div className="pos-card w-full max-w-lg p-8 text-center">
          <h1 className="pos-section-title text-2xl mb-6">Pay using MTN MoMo</h1>
          ...
          <div className="space-y-4 text-left mb-8 p-6 bg-neutral-50 dark:bg-neutral-800/50 rounded-xl border border-neutral-200 dark:border-neutral-700">
            <p className="m-0"><span className="text-neutral-500 dark:text-neutral-400">Merchant Code:</span> <strong className="font-mono">{MTN_MERCHANT_CODE}</strong></p>
            <p className="m-0"><span className="text-neutral-500 dark:text-neutral-400">Dial:</span> <strong className="font-mono text-lg">{MTN_DIAL}</strong></p>
